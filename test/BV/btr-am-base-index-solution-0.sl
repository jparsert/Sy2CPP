...
(synth-fun btr-am ((base (_ BitVec 32)) (index (_ BitVec 32)) (mem (_ BitVec 32)) (bit (_ BitVec 32))) (_ BitVec 32)
    ...
    (Is (_ BitVec 32) (  (Variable (_ BitVec 32)) (bvadd Is Is) (bvneg Is) (bvnot Is) (bvadd Is Is) (bvand Is Is) (bvlshr Is Is) (bvmul Is Is) (bvor Is Is) (bvshl Is Is) (load-val base index Is Start)))))
