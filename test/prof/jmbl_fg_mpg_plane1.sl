...
(synth-fun eq_1 ((x Int) (y Int) (z Int)) Int
    ...
    (y_int Int (x y z y_const_int (- y_int) (+ y_int y_int) (- y_int y_int) (* y_const_int y_int) (* y_int y_const_int) (div y_int y_const_int) (mod y_int y_const_int) (abs y_int) (ite y_bool y_int y_int)))
