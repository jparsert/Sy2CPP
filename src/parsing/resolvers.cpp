...
CoreResolver::lookup_or_resolve_function(const EitherIdentifier &identifier, const std::vector<EitherSort>& arg_sorts) const {
...
std::optional<FunctionDescriptor>
CoreResolver::resolve_special_functions(const EitherIdentifier &identifier, const std::vector<EitherSort>& arg_sorts) {
...
std::optional<FunctionDescriptor>
LIAResolver::lookup_or_resolve_function(const EitherIdentifier &identifier, const std::vector<EitherSort>& arg_sorts) const {
...
std::optional<FunctionDescriptor>
LIAResolver::resolve_special_functions(const EitherIdentifier &identifier, const std::vector<EitherSort> &arg_sorts) {
